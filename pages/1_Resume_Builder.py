...
if st.button("Generate Resume"):
    if not name or not email or not phone:
        ...
        with st.spinner("Generating PDF resume..."):
            ...
            styles.add(ParagraphStyle(name='NameStyle', fontName='Helvetica-Bold', fontSize=24, alignment=1, spaceAfter=12))
            styles.add(ParagraphStyle(name='ContactStyle', fontName='Helvetica', fontSize=10, alignment=1, spaceAfter=24))
            styles.add(ParagraphStyle(name='SectionHead', fontName='Helvetica-Bold', fontSize=12, spaceBefore=12, spaceAfter=6))
            styles.add(ParagraphStyle(name='JobTitle', fontName='Helvetica-Bold', fontSize=10, spaceAfter=2))
            styles.add(ParagraphStyle(name='JobDate', fontName='Helvetica-Oblique', fontSize=9, alignment=2))
            styles.add(ParagraphStyle(name='ResumeBullet', fontName='Helvetica', fontSize=10, leftIndent=18, bulletIndent=0, spaceAfter=4, leading=12))
            styles.add(ParagraphStyle(name='SkillsStyle', fontName='Helvetica', fontSize=10, leading=14))
